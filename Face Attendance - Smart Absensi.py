...
def rekamDataWajah():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            namaFile = str(nim) + '_' + str(nama) + '_' + str(kelas) + '_' + str(mataKuliah) + '_' + str(ambilData) + '.jpg'
...
def markAttendance(name):
    with open("Attendance.csv",'r+') as f:
        ...
        if name not in namelist:
            ...
            f.writelines(f'\n{name},{yourclass},{yournim},{yourcourse},{dtString}')
...
#credit
made = tk.Label(root, text="ABSEN MAHASISWA", font=("Times New Roman",13), bg="black",fg="white")
...
label1 = tk.Label(root, text="Nama Mahasiswa", font="Roboto", fg="white", bg="black")
